...
from etymmap.specific import TemplateHandler, LinkNormalization
from etymmap.specific_en import EtymologyTemplateHandler, configure

configure()


class TestEtymologyTemplateHandler(unittest.TestCase):
    handler: TemplateHandler = EtymologyTemplateHandler()
